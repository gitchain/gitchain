...
Gitchain is using elliptic public key cryptography to implement signing and verification, using P-256 curve \todo{This is not a final decision. There's a lot of interesting materials available on this subject: \cite{safecurves} \cite{trough} \cite{nistcurvesdangers}}.
